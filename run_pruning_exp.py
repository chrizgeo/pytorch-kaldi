...
#not production, but only model files
...
for ep in range(N_ep):
    ...
    for tr_data in tr_data_lst:
        ...
        for ck in range(N_ck_tr):
            ...
            last_trained_cfg = config_chunk_file
            last_pt_file_arch1 = pt_files["architecture1"]
    ...
    #do pruning if pruning is needed in this epoch
    if do_prune:
